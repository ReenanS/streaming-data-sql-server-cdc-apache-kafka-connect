...
namespace Infra.Services
{
    public class SendOperationToStepFunctionService : ISendOperationToStepFunction
    {
        ...
        public async Task ExecuteAsync(StepFunctionInput input, string topic)
        {
            ...
            logger.Information("Step Function Input - TipoOperacao: {tipoOperacao}, CodigoExterno: {codigoExterno}, StateMachineArn: {stateMachineArn}", input.TipoOperacao, input.CodigoExterno, stateMachineArn);
